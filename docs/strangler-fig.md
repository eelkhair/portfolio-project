...
Screenshot:
- `images/Strangler Fig/strangler-fig-stage-1-monolith-primary.png`
...
Screenshot:
- `images/Strangler Fig/strangler-fig-stage-2-connector-introduced.png`
...
Screenshot:
- `images/Strangler Fig/strangler-fig-stage-3-service-extraction.png`
...
Screenshot:
- `images/Strangler Fig/strangler-fig-stage-4-monolith-deprecated-paths.png`
