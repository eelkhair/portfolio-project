...
internal static class HealthCheckExtensions
{
    ...
    {
        var stateStore = new StateStoreOptions { StoreName = StateStores.Redis };
        builder.Services.AddSingleton(_ => new DaprStateStoreHealthCheck(new DaprClientBuilder().Build(), stateStore));

        var secretStore = new SecretStoreOptions { StoreName = SecretStoreNames.Local };
        ...
        builder.Services
            ...
            .AddDapr()
            .AddDaprConfigurationStore("appconfig-ai-service-mcp-integration", o =>
                o.StoreName = "appconfig-ai-service-mcp-integration");
