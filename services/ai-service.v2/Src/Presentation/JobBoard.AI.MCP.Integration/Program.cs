...
using JobBoard.AI.MCP.Integration.Infrastructure;
using JobBoard.AI.MCP.Integration.Tools.Admin;
...
(await builder.AddDaprServices("ai-service-mcp-integration"))
    .ConfigureLogging("ai-service-mcp-integration")
    ...
    .AddOpenTelemetryServices(builder.Configuration, "ai-service-mcp-integration");
...
var mcpBuilder = builder.Services
    ...
    {
        Name = "ai-service-mcp-integration",
        Version = "1.0.0"
    })
...
// Redirect logging to stderr (stdout reserved for MCP JSON-RPC in stdio mode)
